...
class Wall(Component):
    ...
    """
    @classmethod
    def reg(cls, building,area, layers, ):
    ...
    def __init__(self, area, layers, steps = 5, interval=100, T_in=294, T_out=278 ,U_in = 1/.13, U_out=1/.04, name = None):
        """
        Initialize Values
...
class Window(Component):
    ...
    """
    @classmethod
    def reg(cls, building ,area,layers, azimuth, inclination = 90, occlusion = .9 ,name = None):
