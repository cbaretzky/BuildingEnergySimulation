...
htmlhelp_basename = 'BuildingEnergySimulationdoc'
...
latex_documents = [
    (master_doc, 'BuildingEnergySimulation.tex', u'BuildingEnergySimulation Documentation',
     u'Clemens Baretzky', 'manual'),
]
